...
const workflows = [
  { title: 'New Hire', description: 'Create and track new employee onboarding records.', icon: UserPlus, tone: 'from-emerald-600 to-teal-500' },

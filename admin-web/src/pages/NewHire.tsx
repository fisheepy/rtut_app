...
import { isAuthenticationError, RequiredFieldsNote, SessionExpired, TaskStatus } from "../shared/hrPlatformUi";
    ...
    <div className="space-y-6 pb-10">
      ...
      <section className="overflow-hidden rounded-2xl border border-blue-200 bg-white shadow-lg shadow-blue-950/5">
        <div className="border-b border-blue-200 bg-gradient-to-r from-blue-50 via-indigo-50 to-white px-5 py-5">
          <div className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-xl font-semibold text-blue-950">New Hire & Payroll Status</h2><p className="mt-1 text-sm text-blue-700">{hireDateRangeActive ? "Showing every employee hired in the selected date range, including completed and unfinished tasks." : "All unfinished payroll and file tasks remain visible. Completed employees remain visible during their hire or completion month. Rows are ordered by task date."}</p></div><div className="flex flex-wrap gap-2"><span className="rounded-full border border-red-300 bg-red-100 px-3 py-1.5 text-sm font-bold text-red-800">{firstPayrollFinalPendingCount} First Payroll Final Review Needed</span><span className="rounded-full border border-purple-300 bg-purple-100 px-3 py-1.5 text-sm font-bold text-purple-800">{futurePayrollChangeCount} Future Payroll Change</span></div></div>
        </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-violet-200 bg-white shadow-lg shadow-violet-950/5">
        <div className="border-b border-violet-200 bg-gradient-to-r from-violet-50 to-white px-5 py-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            {hireDateRangeActive ? "Showing completed and pending Insurance tasks for the selected Hire Date range, sorted by Effective Date." : "Pending tasks remain until completed and are sorted by the earliest Insurance Effective Date."}
          </p>
        </div>
        <div className="max-h-[55vh] overflow-auto">
              ...
              {insuranceEmployees.length ? (
                ...
                <tr>
                  <td
                    ...
                    colSpan={5}
                  >
                    {hireDateRangeActive ? "No Insurance tasks match this Hire Date range." : "No pending Insurance checks."}
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <section className="overflow-hidden rounded-2xl border border-emerald-200 bg-white shadow-lg shadow-emerald-950/5">
        <div className="border-b border-emerald-200 bg-gradient-to-r from-emerald-50 to-white px-5 py-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            {hireDateRangeActive ? "Showing completed and pending 401(k) tasks for the selected Hire Date range, sorted by Effective Date." : "Pending tasks remain until completed and are sorted by the earliest 401(k) Effective Date."}
          </p>
        </div>
        <div className="max-h-[55vh] overflow-auto">
          <table className="w-full min-w-[760px] text-sm">
              ...
              {retirementEmployees.length ? (
                ...
                <tr>
                  <td
                    ...
                    colSpan={5}
                  >
                    {hireDateRangeActive ? "No 401(k) tasks match this Hire Date range." : "No pending 401(k) checks."}
                  </td>
                </tr>
              )}
            </tbody>
          ...
          <section className="max-h-[92vh] w-full max-w-3xl overflow-auto rounded-2xl bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Changes apply to future new hires and current trackers that have not received final review. Final-locked history keeps its original checklist.
                </p>
              </div>
              <button
      ...
      {showCatalogConfirmation ? (
        <div aria-modal="true" className="fixed inset-0 z-[60] grid place-items-center bg-slate-950/70 p-4" role="dialog">
          <section className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4"><div><h2 className="text-xl font-semibold text-slate-950">Review Checklist Changes</h2><p className="mt-1 text-sm text-slate-500">Changes apply to future records and current trackers awaiting final review. Locked history is preserved.</p></div><button aria-label="Close Checklist Confirmation" className="rounded-lg p-2 text-slate-500 hover:bg-slate-100" onClick={() => setShowCatalogConfirmation(false)} type="button"><X className="h-5 w-5" /></button></div>
            ...
            <label className="mt-4 flex items-start gap-2 rounded-xl border border-amber-300 bg-amber-50 p-4 text-sm font-semibold text-slate-700"><input checked={catalogChangeAcknowledged} className="mt-0.5 h-4 w-4" onChange={(event) => setCatalogChangeAcknowledged(event.target.checked)} type="checkbox" />I reviewed all checklist items and confirm these changes are correct.</label>
